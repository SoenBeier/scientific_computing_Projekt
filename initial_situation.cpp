...
const static int grid_height = 150;
const static int grid_width = 270;
...
static const char plant_layout[] = "golden_cage_neu.bmp";//Name des Gebäudeplans
...
static int panik_schwelle = 3; ///ab welcher Anzahl von konflikten geraet jmd in panik
...
static string take_which_exit = "near"; //  wenn "far" oder "near": w_S wird so verändert, dass jede Person den Ausgang nimmt, der für sie am weitesten/nahesten ist. Bei "default" wird nichts ueberschrieben
/*
...
*/
 ...
 struct analysis_run{
    ...
    double friction = 0.2; ///zufaellig im default
